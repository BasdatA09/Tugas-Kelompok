...
INSERT INTO DOSEN_PEMBIMBING(IDMKS , NIPdosenpembimbing) SELECT m.idmks , d.nip from mata_kuliah_spesial m cross join dosen d order by RANDOM() limit 60;
...
INSERT INTO SARAN_DOSEN_PENGUJI VALUES (35,196105101987032001);
...
******************
*/
INSERT INTO SARAN_DOSEN_PENGUJI(IDMKS , NIPsaranpenguji) SELECT m.idmks , d.nip from mata_kuliah_spesial m cross join dosen d order by RANDOM() limit 50;
...
INSERT INTO DOSEN_PENGUJI VALUES (43,195906171985032002);
...
******************
*/
INSERT INTO DOSEN_PENGUJI(IDMKS , NIPdosenpenguji) SELECT m.idmks , d.nip from mata_kuliah_spesial m cross join dosen d order by RANDOM() limit 60;
